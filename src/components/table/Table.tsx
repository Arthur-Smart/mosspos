...
const Table = () => {
  return (
    <table className="w-full mt-3 overflow-hidden rounded-md">
      ...
      <tr className="w-full text-center">
        <td className="py-2 px-3 text-[16px]">2833</td>
        <td className="py-2 px-3 text-[16px]">Kyle Ross</td>
        <td className="py-2 px-3 text-[16px]">Product</td>
        <td className="py-2 px-3 text-[16px]">522$</td>
        <td className="py-2 px-3 text-[16px]">30/09/2020</td>
        <td className="py-2 px-3 text-[16px]">Kelly Garrett</td>

        <td className=" py-2 px-3 text-[16px]">
          <Popover>
            <PopoverTrigger>
              <p className="action__btn">...</p>
            </PopoverTrigger>
